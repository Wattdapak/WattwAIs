      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            // Read screen-size profiles dynamically
            ...
            return SingleChildScrollView(
              ...
              child: Center(
                child: Container(
                  // Restricts card scaling excessively on large tablets/web environments
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          const Icon(Icons.tune_rounded, color: AppColors.cyan, size: 28),
                      ...
                      // Adaptive Slider Spacing sizing
                      SizedBox(
